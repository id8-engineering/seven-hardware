...
Contributions to [seven-hardware](https://github.com/id8-engineering/seven-hardware/)
are done by first creating an issue [here](https://github.com/id8-engineering/seven-hardware/issues). The change request will be disussed and if approved a pull-request can be opened.
...
- **By opening the issue for discussion:** If you believe that you have found a new bug in this project, you should report it by creating a new issue in the [issue tracker](https://github.com/id8-engineering/seven-hardware/issues).
...
- When opening a new issue in the [issue tracker](https://github.com/id8-engineering/seven-hardware/issues/new/choose), users will be presented with a template that should be filled in.
